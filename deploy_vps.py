...
command = " && ".join([
    ...
    "echo '=== DOCKER BUILD ==='",
    "docker compose -f docker-compose.dokploy.yml build backend 2>&1",
    "echo '=== DOCKER UP ==='",
    "docker rm -f hartbeat-backend 2>/dev/null; docker compose -f docker-compose.dokploy.yml up -d --no-deps backend 2>&1",
    "echo '=== DONE ==='",
])
