...
req2 = urllib.request.Request(
    "https://api.heartbeatharmony.tech/api/admin/study/materials/",
...
sftp = c.open_sftp()
with sftp.open("/tmp/check_materials.py", "w") as f:
    f.write(script)
sftp.close()

stdin, stdout, stderr = c.exec_command("docker cp /tmp/check_materials.py hartbeat-backend:/tmp/check_materials.py && docker exec hartbeat-backend python /tmp/check_materials.py 2>&1")
